...
export function createExportableStorageKeys(storageKeys) {
    return [
        ...
        'comfyui_transport_mode',
        'comfyui_stream_pregen_enabled',
        'comfyui_stream_pregen_min_chars',
        'comfyui_stream_pregen_max_concurrent',
        'comfyui_stream_pregen_stability_ms',
        'comfyui_cache_max_size_mb',
        'comfyui_cache_max_count',
        'comfyui_consistency_profiles',
        'comfyui_active_consistency_profile',
        'selected_embeddings',
