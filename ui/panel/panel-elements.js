export function getPanelInputs() {
    return {
        ...
        transportMode: document.getElementById('comfyui-transport-mode'),
        streamPregenEnabled: document.getElementById('comfyui-stream-pregen-enabled'),
        streamPregenMinChars: document.getElementById('comfyui-stream-pregen-min-chars'),
        streamPregenMaxConcurrent: document.getElementById('comfyui-stream-pregen-max-concurrent'),
        streamPregenStabilityMs: document.getElementById('comfyui-stream-pregen-stability-ms'),
        cacheMaxSizeMB: document.getElementById('comfyui-cache-max-size-mb'),
        cacheMaxCount: document.getElementById('comfyui-cache-max-count'),
